...
| [apps/records-android](https://github.com/pitekusu/shittim-chest/tree/main/apps/records-android) | Androidネイティブアプリ。[29](29_Androidアプリ設計.md)のCompose・Expressive・Circuit／Metro、C03 CI、C13トークン保存、C14認証API、C15 Auth Tab、C16認証画面、C17記録1件表示。C04は保留 |
