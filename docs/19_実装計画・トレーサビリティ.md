...
| Androidへの認証受け渡し（C05〜C07） | [29](29_Androidアプリ設計.md) | `mobile_auth.py`、`mobile_auth_adapters.py`、`mobile_login.py`、`mobile-auth.schema.json`（公開前の契約・保存・ブラウザー認可） | 入力・期限・state／Cookie・秘密非表示、DynamoDB Localの同時更新・二重消費・原子的失敗。Discord本人確認／公開接続はC08以降 |
