...
| [apps/records-android](https://github.com/pitekusu/shittim-chest/tree/main/apps/records-android) | Androidネイティブアプリ。[29](29_Androidアプリ設計.md)の最小Compose画面・ビルド構成、Expressiveデザイン基盤とC02のCircuit／Metro接続 |
