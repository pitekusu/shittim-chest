...
| 議論詳細OGPと投稿前準備 | [24](24_シッテムの箱%20議事録設計.md)、[16](16_セキュリティ・プライバシー詳細設計.md) | Recordsの`ogp.py`、`ogp_render.py`、`ogp_http.py`、`ogp_adapters.py`、`ogp_handler.py` | 公開項目限定、PNG保存後の通知、5秒上限と失敗継続、画像再利用、HTML／SPA／IAM |
