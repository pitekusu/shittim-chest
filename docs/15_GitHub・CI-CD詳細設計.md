...
| 2026-07-31 | Docker reproducible builds / Build Push Action v7 | https://docs.docker.com/build/ci/github-actions/reproducible-builds/、https://github.com/docker/build-push-action | `SOURCE_DATE_EPOCH=0`でindex/config/file metadata時刻を固定し、`imageid`/pushed manifest configをtarget別risk identityへ使用 |
