...
def _admin_status_controller() -> AdminStatusHttpController:
    ...
    if _ADMIN_STATUS_CONTROLLER is None:
        ...
        source = AwsAdminStatusSource(
            ...
            apigateway=boto3.client("apigatewayv2", region_name=region, config=SDK_CONFIG),
            events=boto3.client("events", region_name=region, config=SDK_CONFIG),
            scheduler=boto3.client("scheduler", region_name=region, config=SDK_CONFIG),
            sns=boto3.client("sns", region_name=region, config=SDK_CONFIG),
            ssm=ssm,
            budgets=boto3.client("budgets", region_name="us-east-1", config=SDK_CONFIG),
            cost_explorer=boto3.client("ce", region_name="us-east-1", config=SDK_CONFIG),
            signer=boto3.client("signer", region_name=region, config=SDK_CONFIG),
            ...
            cloudformation_global=boto3.client(
                "cloudformation",
                region_name="us-east-1",
                config=SDK_CONFIG,
            ),
